...
// Define page object
$offer_anh_chaohang_blobview = new coffer_anh_chaohang_blobview();
$Page =& $offer_anh_chaohang_blobview;

// Page init processing
$offer_anh_chaohang_blobview->Page_Init();

// Page main processing
$offer_anh_chaohang_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class coffer_anh_chaohang_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'offer_anh_chaohang_blobview';
	...
	//  - open connection
	//
	function coffer_anh_chaohang_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('offer', 'x_anh_chaohang');
