...
// Define page object
$file_attach_file_fullname_blobview = new cfile_attach_file_fullname_blobview();
$Page =& $file_attach_file_fullname_blobview;

// Page init processing
$file_attach_file_fullname_blobview->Page_Init();

// Page main processing
$file_attach_file_fullname_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cfile_attach_file_fullname_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'file_attach_file_fullname_blobview';
	...
	//  - open connection
	//
	function cfile_attach_file_fullname_blobview() {
		global $conn;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('file_attach');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('file_attach', 'x_file_fullname');
