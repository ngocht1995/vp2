...
// Define page object
$pic_product_sanpham_pic_blobview = new cpic_product_sanpham_pic_blobview();
$Page =& $pic_product_sanpham_pic_blobview;

// Page init processing
$pic_product_sanpham_pic_blobview->Page_Init();

// Page main processing
$pic_product_sanpham_pic_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cpic_product_sanpham_pic_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'pic_product_sanpham_pic_blobview';
	...
	//  - open connection
	//
	function cpic_product_sanpham_pic_blobview() {
		global $conn;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('pic_product');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('pic_product', 'x_sanpham_pic');
