...
// Define page object
$career_nganhnghe_pic_blobview = new ccareer_nganhnghe_pic_blobview();
$Page =& $career_nganhnghe_pic_blobview;

// Page init processing
$career_nganhnghe_pic_blobview->Page_Init();

// Page main processing
$career_nganhnghe_pic_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class ccareer_nganhnghe_pic_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'career_nganhnghe_pic_blobview';
	...
	//  - open connection
	//
	function ccareer_nganhnghe_pic_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('career', 'x_nganhnghe_pic');
