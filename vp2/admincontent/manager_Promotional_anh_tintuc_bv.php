...
// Define page object
$manager_Promotional_anh_tintuc_blobview = new cmanager_Promotional_anh_tintuc_blobview();
$Page =& $manager_Promotional_anh_tintuc_blobview;

// Page init processing
$manager_Promotional_anh_tintuc_blobview->Page_Init();

// Page main processing
$manager_Promotional_anh_tintuc_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cmanager_Promotional_anh_tintuc_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'manager_Promotional_anh_tintuc_blobview';
	...
	//  - open connection
	//
	function cmanager_Promotional_anh_tintuc_blobview() {
		global $conn;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('manager_Promotional');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('manager_Promotional', 'x_anh_tintuc');
		...
		// SQL constructor in manager_Promotional class, manager_Promotionalinfo.php
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('anh_tintuc'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('anh_tintuc'));
				}
				$objBinary->Value = $rs->fields('anh_tintuc');
				if ($bShowThumbnail) {
