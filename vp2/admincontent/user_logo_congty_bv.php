...
// Define page object
$user_logo_congty_blobview = new cuser_logo_congty_blobview();
$Page =& $user_logo_congty_blobview;

// Page init processing
$user_logo_congty_blobview->Page_Init();

// Page main processing
$user_logo_congty_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cuser_logo_congty_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'user_logo_congty_blobview';
	...
	//  - open connection
	//
	function cuser_logo_congty_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('user', 'x_logo_congty');
