...
// Define page object
$UsersRegistered_logo_congty_blobview = new cUsersRegistered_logo_congty_blobview();
$Page =& $UsersRegistered_logo_congty_blobview;

// Page init processing
$UsersRegistered_logo_congty_blobview->Page_Init();

// Page main processing
$UsersRegistered_logo_congty_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cUsersRegistered_logo_congty_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'UsersRegistered_logo_congty_blobview';
	...
	//  - open connection
	//
	function cUsersRegistered_logo_congty_blobview() {
		global $conn;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('UsersRegistered');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('UsersRegistered', 'x_logo_congty');
