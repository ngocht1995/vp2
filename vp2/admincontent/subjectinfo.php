...
// PHPMaker 6 configuration for Table subject
$subject = NULL; // Initialize table object
...
class csubject {
	...
	function csubject() {
		...
		$this->chuyenmuc_id = new cField('subject', 'x_chuyenmuc_id', 'chuyenmuc_id', "intro_subject.chuyenmuc_id", 19, -1, FALSE);
		$this->fields['chuyenmuc_id'] =& $this->chuyenmuc_id;
		$this->ten_chuyenmuc = new cField('subject', 'x_ten_chuyenmuc', 'ten_chuyenmuc', "intro_subject.ten_chuyenmuc", 201, -1, FALSE);
		$this->fields['ten_chuyenmuc'] =& $this->ten_chuyenmuc;
		$this->chuyenmuc_belongto = new cField('subject', 'x_chuyenmuc_belongto', 'chuyenmuc_belongto', "intro_subject.chuyenmuc_belongto", 19, -1, FALSE);
		$this->fields['chuyenmuc_belongto'] =& $this->chuyenmuc_belongto;
		$this->thutu_sapxep = new cField('subject', 'x_thutu_sapxep', 'thutu_sapxep', "intro_subject.thutu_sapxep", 5, -1, FALSE);
		$this->fields['thutu_sapxep'] =& $this->thutu_sapxep;
		$this->trang_thai = new cField('subject', 'x_trang_thai', 'trang_thai', "intro_subject.trang_thai", 19, -1, FALSE);
		$this->fields['trang_thai'] =& $this->trang_thai;
		$this->thoigian_them = new cField('subject', 'x_thoigian_them', 'thoigian_them', "intro_subject.thoigian_them", 135, 7, FALSE);
		$this->fields['thoigian_them'] =& $this->thoigian_them;
		$this->thoigian_sua = new cField('subject', 'x_thoigian_sua', 'thoigian_sua', "intro_subject.thoigian_sua", 135, 7, FALSE);
		$this->fields['thoigian_sua'] =& $this->thoigian_sua;
		$this->nguoi_them = new cField('subject', 'x_nguoi_them', 'nguoi_them', "intro_subject.nguoi_them", 19, -1, FALSE);
		$this->fields['nguoi_them'] =& $this->nguoi_them;
		$this->nguoi_sua = new cField('subject', 'x_nguoi_sua', 'nguoi_sua', "intro_subject.nguoi_sua", 19, -1, FALSE);
		$this->fields['nguoi_sua'] =& $this->nguoi_sua;
		$this->show_home = new cField('subject', 'x_show_home', 'show_home', "intro_subject.show_home", 19, -1, FALSE);
		$this->fields['show_home'] =& $this->show_home;
		$this->show_news = new cField('subject', 'x_show_news', 'show_news', "intro_subject.show_news", 19, -1, FALSE);
		$this->fields['show_news'] =& $this->show_news;
	}
	...
	function SqlWhere() { // Where
		return "intro_subject.chuyenmuc_belongto=0";
	}
	...
	function SqlOrderBy() { // Order By
		return "intro_subject.show_news";
	}
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("subjectview.php", $this->UrlParm());
	}

	// Add url
	function AddUrl() {
		$AddUrl = "subjectadd.php";
	...
	// Edit url
	function EditUrl() {
		return $this->KeyUrl("subjectedit.php", $this->UrlParm());
	}
	...
	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("subjectadd.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=subject" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function LoadListRowValues(&$rs) {
		...
		$this->show_home->setDbValue($rs->fields('show_home'));
		$this->show_news->setDbValue($rs->fields('show_news'));
	}
