...
// and the user's login name can be read with phpCAS::getUser().
 ...
 $_SESSION['user']="ngocht@hpu.edu.vn"
// $attr_thongttin= phpCAS::getAttributes();
// $_SESSION['msv'] =  $attr_thongttin['masinhvien'];
// $_SESSION['msv_login'] =  $attr_thongttin['masinhvien'];
		...
		if ($_SESSION['user'] <> "") {
                        ...
                        if ( $_SESSION['status']=='1') 
                        {
                            ...
                            $rswrk = $conn->Execute($sql_kiemtra);
                             ...
                             if (COUNT($arwrk)==0) 
                             {
                                 if ($_SESSION['role'] == 2) $x=10; else  $x =3; // xac dinh giang vien sinh vien 
                                 $sql_insert= mysql_query('INSERT INTO user (tendangnhap, hoten_nguoilienhe, UserLevelID, xacthuc_boisan, thanhvien_tieubieu, nguoidung_option,ten_congty) VALUES ("'.$_SESSION['user'].'","'.$_SESSION['hovaten'].'",'.$x.',1,1,1,"'.$_SESSION['msv_login'].'")');
                             }
                        }
			// Setup variables
