...
// PHPMaker 6 configuration for Table manager_Promotional
$manager_Promotional = NULL; // Initialize table object

// Define table class
class cmanager_Promotional {
	...
	function cmanager_Promotional() {
		$this->TableVar = "manager_Promotional";
		$this->TableName = "manager_Promotional";
		$this->tintuc_id = new cField('manager_Promotional', 'x_tintuc_id', 'tintuc_id', "Promotional.tintuc_id", 19, -1, FALSE);
		$this->fields['tintuc_id'] =& $this->tintuc_id;
		$this->anh_tintuc = new cField('manager_Promotional', 'x_anh_tintuc', 'anh_tintuc', "Promotional.anh_tintuc", 201, -1, TRUE);
		$this->fields['anh_tintuc'] =& $this->anh_tintuc;
		$this->ten_congty = new cField('manager_Promotional', 'x_ten_congty', 'ten_congty', "user.ten_congty", 201, -1, FALSE);
		$this->fields['ten_congty'] =& $this->ten_congty;
		$this->hoten_nguoilienhe = new cField('manager_Promotional', 'x_hoten_nguoilienhe', 'hoten_nguoilienhe', "user.hoten_nguoilienhe", 200, -1, FALSE);
		$this->fields['hoten_nguoilienhe'] =& $this->hoten_nguoilienhe;
		$this->trang_thai = new cField('manager_Promotional', 'x_trang_thai', 'trang_thai', "Promotional.trang_thai", 19, -1, FALSE);
		$this->fields['trang_thai'] =& $this->trang_thai;
		$this->nguoidung_id = new cField('manager_Promotional', 'x_nguoidung_id', 'nguoidung_id', "Promotional.nguoidung_id", 19, -1, FALSE);
		$this->fields['nguoidung_id'] =& $this->nguoidung_id;
		$this->tieude_tintuc = new cField('manager_Promotional', 'x_tieude_tintuc', 'tieude_tintuc', "Promotional.tieude_tintuc", 201, -1, FALSE);
		$this->fields['tieude_tintuc'] =& $this->tieude_tintuc;
		$this->tukhoa_tintuc = new cField('manager_Promotional', 'x_tukhoa_tintuc', 'tukhoa_tintuc', "Promotional.tukhoa_tintuc", 201, -1, FALSE);
		$this->fields['tukhoa_tintuc'] =& $this->tukhoa_tintuc;
		$this->tomtat_tintuc = new cField('manager_Promotional', 'x_tomtat_tintuc', 'tomtat_tintuc', "Promotional.tomtat_tintuc", 201, -1, FALSE);
		$this->fields['tomtat_tintuc'] =& $this->tomtat_tintuc;
		$this->nguon_tintuc = new cField('manager_Promotional', 'x_nguon_tintuc', 'nguon_tintuc', "Promotional.nguon_tintuc", 201, -1, FALSE);
		$this->fields['nguon_tintuc'] =& $this->nguon_tintuc;
		$this->noidung_tintuc = new cField('manager_Promotional', 'x_noidung_tintuc', 'noidung_tintuc', "Promotional.noidung_tintuc", 201, -1, FALSE);
		$this->fields['noidung_tintuc'] =& $this->noidung_tintuc;
		$this->lienket_tintuc = new cField('manager_Promotional', 'x_lienket_tintuc', 'lienket_tintuc', "Promotional.lienket_tintuc", 201, -1, FALSE);
		$this->fields['lienket_tintuc'] =& $this->lienket_tintuc;
		$this->hienthi_tungay = new cField('manager_Promotional', 'x_hienthi_tungay', 'hienthi_tungay', "Promotional.hienthi_tungay", 135, 7, FALSE);
		$this->fields['hienthi_tungay'] =& $this->hienthi_tungay;
		$this->hienthi_denngay = new cField('manager_Promotional', 'x_hienthi_denngay', 'hienthi_denngay', "Promotional.hienthi_denngay", 135, 7, FALSE);
		$this->fields['hienthi_denngay'] =& $this->hienthi_denngay;
		$this->thoigian_them = new cField('manager_Promotional', 'x_thoigian_them', 'thoigian_them', "Promotional.thoigian_them", 135, 7, FALSE);
		$this->fields['thoigian_them'] =& $this->thoigian_them;
		$this->thoigian_sua = new cField('manager_Promotional', 'x_thoigian_sua', 'thoigian_sua', "Promotional.thoigian_sua", 135, 7, FALSE);
		$this->fields['thoigian_sua'] =& $this->thoigian_sua;
		$this->soluot_truynhap = new cField('manager_Promotional', 'x_soluot_truynhap', 'soluot_truynhap', "Promotional.soluot_truynhap", 19, -1, FALSE);
		$this->fields['soluot_truynhap'] =& $this->soluot_truynhap;
		$this->xuatban = new cField('manager_Promotional', 'x_xuatban', 'xuatban', "Promotional.xuatban", 19, -1, FALSE);
	...
	function HighlightName() {
		return "manager_Promotional_Highlight";
	}
	...
	function SqlSelect() { // Select
		return "SELECT Promotional.tintuc_id, user.ten_congty, user.hoten_nguoilienhe, Promotional.trang_thai, Promotional.nguoidung_id, Promotional.tieude_tintuc, Promotional.tukhoa_tintuc, Promotional.tomtat_tintuc, Promotional.anh_tintuc, Promotional.nguon_tintuc, Promotional.noidung_tintuc, Promotional.lienket_tintuc, Promotional.hienthi_tungay, Promotional.hienthi_denngay, Promotional.thoigian_them, Promotional.thoigian_sua, Promotional.soluot_truynhap, Promotional.xuatban FROM Promotional Inner Join user On Promotional.nguoidung_id = user.nguoidung_id";
	}

	function SqlWhere() { // Where
		return "Promotional.trang_thai=2";
	}
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO Promotional Inner Join user On Promotional.nguoidung_id = user.nguoidung_id ($names) VALUES ($values)";
	}

	// UPDATE statement
	function UpdateSQL(&$rs) {
		$SQL = "UPDATE Promotional Inner Join user On Promotional.nguoidung_id = user.nguoidung_id SET ";
		foreach ($rs as $name => $value) {
	...
	function DeleteSQL(&$rs) {
		$SQL = "DELETE FROM Promotional Inner Join user On Promotional.nguoidung_id = user.nguoidung_id WHERE ";
	...
	function SqlKeyFilter() {
		return "Promotional.tintuc_id = @tintuc_id@";
	}
	...
	function getReturnUrl() {
		...
		if (@$_SESSION[EW_PROJECT_NAME . "_" . $this->TableVar . "_" . EW_TABLE_RETURN_URL] <> "") {
			...
			return "manager_Promotionallist.php";
		}
	}
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("manager_Promotionalview.php", $this->UrlParm());
	}

	// Add url
	function AddUrl() {
		$AddUrl = "manager_Promotionaladd.php";
	...
	// Edit url
	function EditUrl() {
		return $this->KeyUrl("manager_Promotionaledit.php", $this->UrlParm());
	}
	...
	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("manager_Promotionaladd.php", $this->UrlParm());
	}
	...
	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("manager_Promotionaldelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=manager_Promotional" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function RenderListRow() {
		...
		if (!is_null($this->anh_tintuc->Upload->DbValue)) {
			...
			if ($this->Export <> "") $manager_Promotional->anh_tintuc->HrefValue = ew_ConvertFullUrl($this->anh_tintuc->HrefValue);
		} else {
