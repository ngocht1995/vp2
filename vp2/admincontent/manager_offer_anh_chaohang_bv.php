...
// Define page object
$manager_offer_anh_chaohang_blobview = new cmanager_offer_anh_chaohang_blobview();
$Page =& $manager_offer_anh_chaohang_blobview;

// Page init processing
$manager_offer_anh_chaohang_blobview->Page_Init();

// Page main processing
$manager_offer_anh_chaohang_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cmanager_offer_anh_chaohang_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'manager_offer_anh_chaohang_blobview';
	...
	//  - open connection
	//
	function cmanager_offer_anh_chaohang_blobview() {
		global $conn;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('manager_offer');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('manager_offer', 'x_anh_chaohang');
