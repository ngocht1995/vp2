                ...
                $ID_Group= $_POST['x_s_group'];
                 $s_public = $_POST['s_public'];
                  ...
                  if($_SESSION["s_number"]==3){
                    $sql= " UPDATE  t_question SET active = 1, status = 1,s_finish= 1, s_public = " .$s_public .",ID_Group = '" .$ID_Group ."' ,datetime_Update = '". date("Y-m-d H:i:s") . "' ,user_IDAndser =  '". $_SESSION['user']. "' " ." WHERE question_id = '".   $_SESSION["question_id"] ."'";
                  }else
                  {
