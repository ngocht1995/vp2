...
<?php include "Thongtin_canhaninfo.php" ?>
...
// Define page object
$Thongtin_canhan_logo_congty_blobview = new cThongtin_canhan_logo_congty_blobview();
$Page =& $Thongtin_canhan_logo_congty_blobview;

// Page init processing
$Thongtin_canhan_logo_congty_blobview->Page_Init();

// Page main processing
$Thongtin_canhan_logo_congty_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cThongtin_canhan_logo_congty_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'Thongtin_canhan_logo_congty_blobview';
	...
	//  - open connection
	//
	function cThongtin_canhan_logo_congty_blobview() {
		global $conn;

		// Initialize table object
		$GLOBALS["Thongtin_canhan"] = new cThongtin_canhan();
		...
		if (!defined("EW_TABLE_NAME"))
			define("EW_TABLE_NAME", 'Thongtin_canhan', TRUE);
	...
	//
	function Page_Init() {
		global $gsExport, $gsExportFile, $Thongtin_canhan;
		global $Security;
		...
		$Security->LoadCurrentUserLevel('Thongtin_canhan');
	...
	//
	function Page_Main() {
		global $conn, $Thongtin_canhan;

		// Get key
		if (@$_GET["nguoidung_id"] <> "") {
			$Thongtin_canhan->nguoidung_id->setQueryStringValue($_GET["nguoidung_id"]);
		} else {
			$this->Page_Terminate(); // Exit
			exit();
		}
		$objBinary = new cUpload('Thongtin_canhan', 'x_logo_congty');
		...
		$sFilter = $Thongtin_canhan->KeyFilter();

		// Set up filter (SQL WHERE clause) and get return SQL
		// SQL constructor in Thongtin_canhan class, Thongtin_canhaninfo.php

		$Thongtin_canhan->CurrentFilter = $sFilter;
		$sSql = $Thongtin_canhan->SQL();
