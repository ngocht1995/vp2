...
// PHPMaker 6 configuration for Table Read
$Read = NULL; // Initialize table object
...
class cRead {
	...
	function cRead() {
		$this->TableVar = "Read";
		$this->TableName = "Read";
		$this->thu_id = new cField('Read', 'x_thu_id', 'thu_id', "`thu_id`", 19, -1, FALSE);
		$this->fields['thu_id'] =& $this->thu_id;
		$this->nguoidung_id = new cField('Read', 'x_nguoidung_id', 'nguoidung_id', "`nguoidung_id`", 19, -1, FALSE);
		$this->fields['nguoidung_id'] =& $this->nguoidung_id;
		$this->tieu_de = new cField('Read', 'x_tieu_de', 'tieu_de', "`tieu_de`", 201, -1, FALSE);
		$this->fields['tieu_de'] =& $this->tieu_de;
		$this->noidung_lienhe = new cField('Read', 'x_noidung_lienhe', 'noidung_lienhe', "`noidung_lienhe`", 201, -1, FALSE);
		$this->fields['noidung_lienhe'] =& $this->noidung_lienhe;
		$this->nguoi_lienhe = new cField('Read', 'x_nguoi_lienhe', 'nguoi_lienhe', "`nguoi_lienhe`", 201, -1, FALSE);
		$this->fields['nguoi_lienhe'] =& $this->nguoi_lienhe;
		$this->gioi_tinh = new cField('Read', 'x_gioi_tinh', 'gioi_tinh', "`gioi_tinh`", 19, -1, FALSE);
		$this->fields['gioi_tinh'] =& $this->gioi_tinh;
		$this->quocgia_id = new cField('Read', 'x_quocgia_id', 'quocgia_id', "`quocgia_id`", 19, -1, FALSE);
		$this->fields['quocgia_id'] =& $this->quocgia_id;
		$this->diachi_email = new cField('Read', 'x_diachi_email', 'diachi_email', "`diachi_email`", 201, -1, FALSE);
		$this->fields['diachi_email'] =& $this->diachi_email;
		$this->ma_quocgia_tel = new cField('Read', 'x_ma_quocgia_tel', 'ma_quocgia_tel', "`ma_quocgia_tel`", 200, -1, FALSE);
		$this->fields['ma_quocgia_tel'] =& $this->ma_quocgia_tel;
		$this->ma_vung_tel = new cField('Read', 'x_ma_vung_tel', 'ma_vung_tel', "`ma_vung_tel`", 200, -1, FALSE);
		$this->fields['ma_vung_tel'] =& $this->ma_vung_tel;
		$this->so_dienthoai = new cField('Read', 'x_so_dienthoai', 'so_dienthoai', "`so_dienthoai`", 200, -1, FALSE);
		$this->fields['so_dienthoai'] =& $this->so_dienthoai;
		$this->ma_quocgia_fax = new cField('Read', 'x_ma_quocgia_fax', 'ma_quocgia_fax', "`ma_quocgia_fax`", 200, -1, FALSE);
		$this->fields['ma_quocgia_fax'] =& $this->ma_quocgia_fax;
		$this->ma_vung_fax = new cField('Read', 'x_ma_vung_fax', 'ma_vung_fax', "`ma_vung_fax`", 200, -1, FALSE);
		$this->fields['ma_vung_fax'] =& $this->ma_vung_fax;
		$this->so_fax = new cField('Read', 'x_so_fax', 'so_fax', "`so_fax`", 200, -1, FALSE);
		$this->fields['so_fax'] =& $this->so_fax;
		$this->dia_chi = new cField('Read', 'x_dia_chi', 'dia_chi', "`dia_chi`", 201, -1, FALSE);
		$this->fields['dia_chi'] =& $this->dia_chi;
		$this->trang_thai = new cField('Read', 'x_trang_thai', 'trang_thai', "user_inbox.trang_thai", 19, -1, FALSE);
		$this->fields['trang_thai'] =& $this->trang_thai;
		$this->ngay_gui = new cField('Read', 'x_ngay_gui', 'ngay_gui', "`ngay_gui`", 135, 7, FALSE);
		$this->fields['ngay_gui'] =& $this->ngay_gui;
		$this->ngay_doc = new cField('Read', 'x_ngay_doc', 'ngay_doc', "`ngay_doc`", 135, 7, FALSE);
	...
	function SqlWhere() { // Where
		return "user_inbox.trang_thai = 2";
	}
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("Readview.php", $this->UrlParm());
	}
	...
	// Edit url
	function EditUrl() {
		return $this->KeyUrl("Readedit.php", $this->UrlParm());
	}
	...
	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("Readadd.php", $this->UrlParm());
	}
	...
	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("Readdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=Read" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
	...
	function RenderListRow() {
		...
		// ngay_doc
		$this->ngay_doc->ViewValue = $this->ngay_doc->CurrentValue;
		$this->ngay_doc->ViewValue = ew_FormatDateTime($this->ngay_doc->ViewValue, 7);
		$this->ngay_doc->CssStyle = "";
		$this->ngay_doc->CssClass = "";
		$this->ngay_doc->ViewCustomAttributes = "";
