...
// PHPMaker 6 configuration for Table t_phanhoi
$t_phanhoi = NULL; // Initialize table object
...
class ct_phanhoi {
	...
	function ct_phanhoi() {
		$this->TableVar = "t_phanhoi";
		$this->TableName = "t_phanhoi";
		$this->id_contact = new cField('t_phanhoi', 'x_id_contact', 'id_contact', "`id_contact`", 19, -1, FALSE);
		$this->fields['id_contact'] =& $this->id_contact;
		$this->c_type = new cField('t_phanhoi', 'x_c_type', 'c_type', "contact.c_type", 19, -1, FALSE);
		$this->fields['c_type'] =& $this->c_type;
		$this->c_hoten = new cField('t_phanhoi', 'x_c_hoten', 'c_hoten', "`c_hoten`", 200, -1, FALSE);
		$this->fields['c_hoten'] =& $this->c_hoten;
		$this->c_email = new cField('t_phanhoi', 'x_c_email', 'c_email', "`c_email`", 200, -1, FALSE);
		$this->fields['c_email'] =& $this->c_email;
		$this->c_tieude = new cField('t_phanhoi', 'x_c_tieude', 'c_tieude', "`c_tieude`", 200, -1, FALSE);
		$this->fields['c_tieude'] =& $this->c_tieude;
		$this->c_tel = new cField('t_phanhoi', 'x_c_tel', 'c_tel', "`c_tel`", 200, -1, FALSE);
		$this->fields['c_tel'] =& $this->c_tel;
		$this->c_noidung = new cField('t_phanhoi', 'x_c_noidung', 'c_noidung', "`c_noidung`", 201, -1, FALSE);
		$this->fields['c_noidung'] =& $this->c_noidung;
		$this->c_read_time = new cField('t_phanhoi', 'x_c_read_time', 'c_read_time', "`c_read_time`", 135, 7, FALSE);
		$this->fields['c_read_time'] =& $this->c_read_time;
		$this->c_add_time = new cField('t_phanhoi', 'x_c_add_time', 'c_add_time', "`c_add_time`", 135, 7, FALSE);
		$this->fields['c_add_time'] =& $this->c_add_time;
		$this->c_status = new cField('t_phanhoi', 'x_c_status', 'c_status', "`c_status`", 19, -1, FALSE);
	...
	// View url
	function ViewUrl() {
		return $this->KeyUrl("t_phanhoiview.php", $this->UrlParm());
	}

	// Add url
	function AddUrl() {
		$AddUrl = "t_phanhoiadd.php";
	...
	// Edit url
	function EditUrl() {
		return $this->KeyUrl("t_phanhoiedit.php", $this->UrlParm());
	}
	...
	// Copy url
	function CopyUrl() {
		return $this->KeyUrl("t_phanhoiadd.php", $this->UrlParm());
	}
	...
	// Delete url
	function DeleteUrl() {
		return $this->KeyUrl("t_phanhoidelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=t_phanhoi" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;
