...
// Define page object
$file_attach_article_file_fullname_blobview = new cfile_attach_article_file_fullname_blobview();
$Page =& $file_attach_article_file_fullname_blobview;

// Page init processing
$file_attach_article_file_fullname_blobview->Page_Init();

// Page main processing
$file_attach_article_file_fullname_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cfile_attach_article_file_fullname_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'file_attach_article_file_fullname_blobview';
	...
	//  - open connection
	//
	function cfile_attach_article_file_fullname_blobview() {
		global $conn;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('file_attach_article');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('file_attach_article', 'x_file_fullname');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('file_fullname'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('file_fullname'));
				}
				$objBinary->Value = $rs->fields('file_fullname');
				if ($bShowThumbnail) {
