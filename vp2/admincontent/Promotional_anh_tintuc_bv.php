...
// Define page object
$Promotional_anh_tintuc_blobview = new cPromotional_anh_tintuc_blobview();
$Page =& $Promotional_anh_tintuc_blobview;

// Page init processing
$Promotional_anh_tintuc_blobview->Page_Init();

// Page main processing
$Promotional_anh_tintuc_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cPromotional_anh_tintuc_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'Promotional_anh_tintuc_blobview';
	...
	//  - open connection
	//
	function cPromotional_anh_tintuc_blobview() {
		global $conn;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('Promotional');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('Promotional', 'x_anh_tintuc');
