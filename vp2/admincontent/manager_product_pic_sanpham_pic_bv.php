...
<?php include "Quantri_sanphaminfo.php" ?>
...
// Define page object
$manager_product_pic_sanpham_pic_blobview = new cmanager_product_pic_sanpham_pic_blobview();
$Page =& $manager_product_pic_sanpham_pic_blobview;

// Page init processing
$manager_product_pic_sanpham_pic_blobview->Page_Init();

// Page main processing
$manager_product_pic_sanpham_pic_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cmanager_product_pic_sanpham_pic_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'manager_product_pic_sanpham_pic_blobview';
	...
	//  - open connection
	//
	function cmanager_product_pic_sanpham_pic_blobview() {
		global $conn;
		...
		// Initialize other table object
		$GLOBALS['manager_product'] = new cQuantri_sanpham();
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('manager_product_pic');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('manager_product_pic', 'x_sanpham_pic');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('sanpham_pic'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('sanpham_pic'));
				}
				$objBinary->Value = $rs->fields('sanpham_pic');
				if ($bShowThumbnail) {
