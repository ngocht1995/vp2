...
// Define page object
$products_anh_nho_blobview = new cproducts_anh_nho_blobview();
$Page =& $products_anh_nho_blobview;

// Page init processing
$products_anh_nho_blobview->Page_Init();

// Page main processing
$products_anh_nho_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cproducts_anh_nho_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'products_anh_nho_blobview';
	...
	//  - open connection
	//
	function cproducts_anh_nho_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('products', 'x_anh_nho');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				if (trim(strval($rs->fields('anh_nho'))) <> "") {
					header("Content-Disposition: attachment; filename=" . $rs->fields('anh_nho'));
				}
				$objBinary->Value = $rs->fields('anh_nho');
				if ($bShowThumbnail) {
