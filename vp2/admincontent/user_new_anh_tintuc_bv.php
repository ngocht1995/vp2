...
// Define page object
$user_new_anh_tintuc_blobview = new cuser_new_anh_tintuc_blobview();
$Page =& $user_new_anh_tintuc_blobview;

// Page init processing
$user_new_anh_tintuc_blobview->Page_Init();

// Page main processing
$user_new_anh_tintuc_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cuser_new_anh_tintuc_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'user_new_anh_tintuc_blobview';
	...
	//  - open connection
	//
	function cuser_new_anh_tintuc_blobview() {
		global $conn;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('user_new');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('user_new', 'x_anh_tintuc');
