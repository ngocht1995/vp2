...
// Define page object
$advertising_anh_logo_blobview = new cadvertising_anh_logo_blobview();
$Page =& $advertising_anh_logo_blobview;

// Page init processing
$advertising_anh_logo_blobview->Page_Init();

// Page main processing
$advertising_anh_logo_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cadvertising_anh_logo_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'advertising_anh_logo_blobview';
	...
	//  - open connection
	//
	function cadvertising_anh_logo_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('advertising', 'x_anh_logo');
