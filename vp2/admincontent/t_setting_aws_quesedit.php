...
// Define page object
$t_setting_aws_ques_edit = new ct_setting_aws_ques_edit();
$Page =& $t_setting_aws_ques_edit;

// Page init processing
$t_setting_aws_ques_edit->Page_Init();

// Page main processing
$t_setting_aws_ques_edit->Page_Main();
?>
...
// Create page object
var t_setting_aws_ques_edit = new ew_Page("t_setting_aws_ques_edit");

// page properties
t_setting_aws_ques_edit.PageID = "edit"; // page ID
var EW_PAGE_ID = t_setting_aws_ques_edit.PageID; // for backward compatibility

// extend page with ValidateForm function
t_setting_aws_ques_edit.ValidateForm = function(fobj) {
...
t_setting_aws_ques_edit.Form_CustomValidate = 
 function(fobj) { // DO NOT CHANGE THIS LINE!

 	// Your custom validation code here, return false if invalid. 
 	return true;
 }
t_setting_aws_ques_edit.SelectAllKey = function(elem) {
	ew_SelectAll(elem);
}
<?php if (EW_CLIENT_VALIDATE) { ?>
t_setting_aws_ques_edit.ValidateRequired = true; // uses JavaScript validation
<?php } else { ?>
t_setting_aws_ques_edit.ValidateRequired = false; // no JavaScript validation
<?php } ?>
...
<?php $t_setting_aws_ques_edit->ShowMessage() ?>
<form name="ft_setting_aws_quesedit" id="ft_setting_aws_quesedit" action="<?php echo ew_CurrentPage() ?>" method="post" onsubmit="return t_setting_aws_ques_edit.ValidateForm(this);">
<p>
<input type="hidden" name="a_table" id="a_table" value="t_setting_aws_ques">
...
<?php if ($t_setting_aws_ques->datetime->Visible) { // datetime ?>
	<tr<?php echo $t_setting_aws_ques->datetime->RowAttributes ?>>
		<td class="ewTableHeader">Thời gian<span class="ewRequired">&nbsp;*</span></td>
...
<input type="hidden" name="x_id" id="x_id" value="<?php echo ew_HtmlEncode($t_setting_aws_ques->id->CurrentValue) ?>">
<p>
...
// Page Class
//
class ct_setting_aws_ques_edit {
	...
	// Page Object Name
	var $PageObjName = 't_setting_aws_ques_edit';
	...
	//  - open connection
	//
	function ct_setting_aws_ques_edit() {
		global $conn;
	...
	function Page_Main() {
		...
		if (@$_POST["a_edit"] <> "") {
			$t_setting_aws_ques->CurrentAction = $_POST["a_edit"]; // Get action code
			$this->LoadFormValues(); // Get form values

			// Validate Form
			if (!$this->ValidateForm()) {
				$t_setting_aws_ques->CurrentAction = ""; // Form error, reset action
				$this->setMessage($gsFormError);
				$this->RestoreFormValues();
			}
		} else {
			$t_setting_aws_ques->CurrentAction = "I"; // Default action is display
		}

		// Check if valid key
		if ($t_setting_aws_ques->id->CurrentValue == "")
			$this->Page_Terminate("t_setting_aws_queslist.php"); // Invalid key, return to list
		switch ($t_setting_aws_ques->CurrentAction) {
			case "I": // Get a record to display
				...
				break;
			Case "U": // Update
				$t_setting_aws_ques->SendEmail = TRUE; // Send email on update success
		...
		// Render the record
		$t_setting_aws_ques->RowType = EW_ROWTYPE_EDIT; // Render as edit
		$this->RenderRow();
	}
	...
	function RenderRow() {
		...
		} elseif ($t_setting_aws_ques->RowType == EW_ROWTYPE_EDIT) { // Edit row
	...
	function EditRow() {
		...
		if ($rs->EOF) {
			...
			$bUpdateRow = $t_setting_aws_ques->Row_Updating($rsold, $rsnew);
			if ($bUpdateRow) {
				$conn->raiseErrorFn = 'ew_ErrorFn';
				$EditRow = $conn->Execute($t_setting_aws_ques->UpdateSQL($rsnew));
				$conn->raiseErrorFn = '';
			} else {
		...
		if ($EditRow)
			$t_setting_aws_ques->Row_Updated($rsold, $rsnew);
		$rs->Close();
		return $EditRow;
	}
