...
// Define page object
$Nganhnghe_nganhnghe_pic_blobview = new cNganhnghe_nganhnghe_pic_blobview();
$Page =& $Nganhnghe_nganhnghe_pic_blobview;

// Page init processing
$Nganhnghe_nganhnghe_pic_blobview->Page_Init();

// Page main processing
$Nganhnghe_nganhnghe_pic_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cNganhnghe_nganhnghe_pic_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'Nganhnghe_nganhnghe_pic_blobview';
	...
	//  - open connection
	//
	function cNganhnghe_nganhnghe_pic_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('Nganhnghe', 'x_nganhnghe_pic');
		...
		if ($rs = $conn->Execute($sSql)) {
			if (!$rs->EOF) {
				...
				$objBinary->Value = $rs->fields('nganhnghe_pic');
				if ($bShowThumbnail) {
