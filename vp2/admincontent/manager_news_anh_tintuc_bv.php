...
// Define page object
$manager_news_anh_tintuc_blobview = new cmanager_news_anh_tintuc_blobview();
$Page =& $manager_news_anh_tintuc_blobview;

// Page init processing
$manager_news_anh_tintuc_blobview->Page_Init();

// Page main processing
$manager_news_anh_tintuc_blobview->Page_Main();
?>
<?php
...
// Page Class
//
class cmanager_news_anh_tintuc_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'manager_news_anh_tintuc_blobview';
	...
	//  - open connection
	//
	function cmanager_news_anh_tintuc_blobview() {
		global $conn;
	...
	function Page_Init() {
		...
		$Security->LoadCurrentUserLevel('manager_news');
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('manager_news', 'x_anh_tintuc');
		...
		// SQL constructor in manager_news class, manager_newsinfo.php
