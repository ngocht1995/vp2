...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <title>Văn phòng hỗ trợ sinh viên - Điểm rèn luyện</title>
...
<form id="form1" action="exporttoexcel.php" method="post" onsubmit='
    ...
    <a href="../tracuutt/"> Trở lại trang chủ</a>
      <div id="ReportTable1">  
 ...
 <?php $result = $_SESSION['result'] ; ?>     
           <table cellpadding="1" cellspacing="0" border="1" width="57%">
                    ...
                    <tr>           
                            <td  width="220px;" class="sophieu" align="center" >Năm học</td>
                            <td  width="220x" class="sophieu" align="center" >Học kỳ</td>
                            <td  width="220px;" class="ngaythu" align="center"> Điểm rèn luyện</td>
                    ...
                    <tr class="gradeX">
                            ...
                            <td align="center"><?php echo $result[$i]['Diem']; ?></td>
                    </tr>
                   <?php } ?>        
   </table>
           <table >
 ...
 <?php $result = $_SESSION['result'] ; ?>     
         <table cellpadding="1" width="70%" cellspacing="0" border="1" class="display dataTable" id="allan" style="position: absolute;left:-999999;margin-top: 10px;">
