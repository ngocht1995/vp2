...
$(document).ready(function(){
        ...
        // });
                          ...
                          <?php } else {?>
                           <?php for($i =0; $i<Count($result); $i++)
                            ...
                            <tr class="gradeX">
                                    <td align='center' class="center"><?php echo $i+1; ?></td> 
                                    <td align='center' class="center"><a href="#" id="masinhvien_<?php echo $i?>"><?php echo $result[$i]['MaSinhVien']; ?></a>
 ...
 <script type="text/javascript">
$(document).ready(function(){
     $("#masinhvien_<?php echo $i?>").click(function () {
      alert("alert");
 ...
 <?php } else { ?>
    ...
    <h2 style="color:red;">không có sinh viên này trong trường!</h2>
    </center>
   </div>
